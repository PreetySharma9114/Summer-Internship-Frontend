...

  {
    ...
    children: [
...

      {
        path: 'portfolio',
        loadComponent: () =>
          import('./features/portfolio/pages/portfolio/portfolio.page').then(
            (m) => m.PortfolioPage,
          ),
      },

      {
        path: 'influencer/:profileId',
        loadComponent: () =>
          import('./features/profile/pages/influencer-details/influencer-details.page').then(
            (m) => m.InfluencerDetailsPage,
          ),
      },
    ],
  },
